...
echo ""
echo "Next steps:"
echo "  1. Open your project in VS Code with Claude Code"
echo "  2. Fill in your current focus in memory.md"
echo "  3. Add project-specific rules to directives.md"
echo "  4. Type /vault at any time to grow your second brain"
echo "  5. Type /setup to change your settings"
echo ""
